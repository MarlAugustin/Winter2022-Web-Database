...
<html>
    ...
    <body>
        ...
        <p>Pour l'ajout d'une équipe, il faut clique sur [Ajouter une équipe].</p>
        <p>Pour modifier ou supprimer une partie il suffit de cliquer sur [Modifier] ou [Supprimer].</p>
        ...
        <h3>Relation entre les tables</h3>
        <p><img src="Contenu/photo bd.png" alt="Photo bd" class="size" /></p>
        <h3>Inspiration pour la bd</h3>
        <p><img src="Contenu/photo_bd_database.png" alt="Photo de Lexemple" class="size" /></p>
